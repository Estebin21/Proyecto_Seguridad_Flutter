...
List<List<Activity>> activityGroups = [
  ...
  [
    Activity(
      ...
      contentType: "image",
      contentPath: "assets/images/1_estafas_telefonicas.png",
      order: 1,
    ),
    Activity(
      ...
      contentType: "video",
      contentPath: "assets/videos/2_guia_whatsapp.mp4",
      order: 2,
    ),
    Activity(
      title: "Presentación sobre contraseñas fuertes",
      description: "Imagen educativa sobre buenas prácticas.",
      contentType: "image",
      contentPath: "assets/images/3_contrasenia_segura.png",
      order: 3,
    ),
    Activity(
      ...
      contentType: "image",
      contentPath: "assets/images/4_evitar_fraudes_online.png",
      order: 4,
    ),
    Activity(
      ...
      contentType: "image",
      contentPath: "assets/images/5_seguridad_correo.png",
      order: 5,
    ),
    Activity(
      ...
      contentType: "image",
      contentPath: "assets/images/6_wifi_publico.png",
      order: 6,
    ),
    Activity(
      title: "Cómo identificar correos fraudulentos",
      description: "Actividad interactiva para reconocer correos fraudulentos.",
      contentType: "drag",
      contentPath: "",
      order: 7,
    ),
    Activity(
      ...
      contentType: "video",
      contentPath: "assets/videos/8_estafas_online.mp4",
      order: 8,
    ),
    Activity(
      ...
      contentType: "presentation",
      contentPath: "assets/presentations/9_info_personal.pdf",
      order: 9,
    ),
    Activity(
